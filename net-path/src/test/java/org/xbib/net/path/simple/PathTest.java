...
public class PathTest {
    ...
    void testPatternComparatorSort() {
        ...
        assertEquals("/hotels/new", paths.get(0).getPattern());
        ...
        paths.sort(comparator);
        assertEquals("/hotels/new", paths.get(0).getPattern());
        assertEquals("/hotels/*", paths.get(1).getPattern());
        ...
        paths.add(Path.of("/hotels/*"));
        paths.sort(comparator);
        assertEquals("/hotels/*", paths.get(0).getPattern());
        assertEquals("/hotels/**", paths.get(1).getPattern());
        ...
        paths.sort(comparator);
        assertEquals("/hotels/new", paths.get(0).getPattern());
        assertEquals("/hotels/{hotel}", paths.get(1).getPattern());
        ...
        assertEquals("/hotels/new", paths.get(0).getPattern());
        assertEquals("/hotels/{hotel}", paths.get(1).getPattern());
        assertEquals("/hotels/*", paths.get(2).getPattern());
        ...
        paths.sort(comparator);
        assertEquals("/hotels/ne*", paths.get(0).getPattern());
        assertEquals("/hotels/n*", paths.get(1).getPattern());
        ...
        paths.sort(comparator);
        assertEquals("/**/endUser/action/login.*", paths.get(0).getPattern());
        assertEquals("/**/login.*", paths.get(1).getPattern());
    }
}
