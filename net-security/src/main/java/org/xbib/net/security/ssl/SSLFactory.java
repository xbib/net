...
public final class SSLFactory {
    ...
    public static class Builder {
        ...
        public <T extends X509TrustManager> Builder withTrustMaterial(T trustManager,
            ...
            KeyStore trustStore = KeyStoreUtils.createTrustStore(Arrays.asList(trustManager.getAcceptedIssuers()));
        ...
        public Builder withIdentityMaterial(Key privateKey,
        ...
        public Builder withCiphers(Iterable<String> ciphers) {
            ciphers.forEach(this.ciphers::add);
            return this;
        }
